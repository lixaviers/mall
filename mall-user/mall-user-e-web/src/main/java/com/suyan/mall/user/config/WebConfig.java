 ...
 */
package com.suyan.mall.user.config;
...
import com.suyan.mall.user.interceptor.UserEInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    @Autowired
    private UserEInterceptor userEInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(this.userEInterceptor).addPathPatterns("/e/**");
    }
