package com.suyan.mall.goods.interceptor;
 ...
 */
@Component
public class UserEInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        try {
            ...
            UserInfoVO userInfo = UserUtil.getUser(SystemPlatformEnum.E.getCode());
            if (userInfo == null) {
                returnErrorJson(response, JsonUtil.toJsonStringNullValue(Result.newError(ResultCode.NO_LOGGED_IN)));
                return false;
            }
            if (!SystemPlatformEnum.E.equals(userInfo.getSystemPlatform())) {
